...
[![License MIT](https://img.shields.io/badge/License-MIT-111)](https://mit-license.org)
[![GitHub](https://img.shields.io/badge/GitHub-0FBF3E?logo=github)](https://github.com/GarthTB/RimeDictManager)
[![版本 2.0.0](https://img.shields.io/badge/版本-2.0.0-0C0)](https://github.com/GarthTB/RimeDictManager/releases/latest)
...
本程序为个人项目，不提供商业支持。使用前请备份词库文件。
开发者不对因使用本程序而造成的任何数据损失负责。
